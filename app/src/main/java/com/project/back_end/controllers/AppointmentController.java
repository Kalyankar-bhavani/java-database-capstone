...
public class AppointmentController {
    ...
    public ResponseEntity<?> getAppointments(
        ...
        boolean valid = service.validateToken("doctor", token);
    ...
    public ResponseEntity<?> bookAppointment(
        ...
        boolean valid = service.validateToken("patient", token);
        ...
        if (validation == 0) {
            return ResponseEntity.badRequest()
                    .body(Map.of("message", "Selected slot is unavailable"));
        }
    ...
    public ResponseEntity<?> updateAppointment(
        ...
        String response = appointmentService.updateAppointment(
                appointmentId,
                appointment,
                patientId
        );
    ...
    public ResponseEntity<?> cancelAppointment(
        ...
        String response = appointmentService.cancelAppointment(
                appointmentId,
                patientId
        );
