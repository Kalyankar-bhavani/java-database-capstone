...
function renderHeader() {
    ...
    if (role === "admin") {
        ...
        headerContent += `
            ...
            <button id="logoutBtn" class="adminBtn">
                Logout
            </button>
        `;
    }
    ...
    // LOGGED PATIENT
        ...
        headerContent += `
            <button id="patientHomeBtn" class="adminBtn">
                Home
            </button>

            <button id="patientAppointmentsBtn" class="adminBtn">
                Appointments
            </button>

            <button id="logoutPatientBtn" class="adminBtn">
                Logout
            </button>
        `;
    }
    ...
    const patientAppointmentsBtn =
        document.getElementById("patientAppointmentsBtn");
